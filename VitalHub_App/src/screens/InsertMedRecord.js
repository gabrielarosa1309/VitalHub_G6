...
import { Container, ContainerScroll, Scroll } from "../components/Container/Style";
...
import { Button, ButtonCamera, ButtonInsert, ButtonTxt, ContainerImage } from "../components/EntryButton/Style";
    ...
    return (
        <Container>
            ...
            <Scroll>
                ...
                <ButtonInsert onPress={() => InserirExame()}>
